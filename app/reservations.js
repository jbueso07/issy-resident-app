...
export default function ReservationsScreen() {
  ...
  // Handlers
  // Helper: calcula el primer día disponible (hoy)
  ...
  // advance_booking_days = días hacia adelante visibles (hoy + advance_booking_days)
  const generateDates = () => {
    const dates = [];
    const advanceDays = parseInt(selectedArea?.advance_booking_days) || 1;

    // Mostrar hoy + los próximos advance_booking_days días
