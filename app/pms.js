      ...
      {tenants.length === 0 ? (
        ...
        tenants.map(tenant => (
          <View key={tenant.id} style={styles.card}>
            ...
            <Text style={styles.cardMeta}>{tenant.property_name || 'Sin asignar'}</Text>
          </View>
        ))
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  // Tabs - DISEÑO COMPACTO
  tabsContainer: { backgroundColor: '#FFF', paddingVertical: 8, paddingHorizontal: 12, borderBottomWidth: 1, borderBottomColor: '#E5E7EB' },
  tab: { paddingHorizontal: 14, paddingVertical: 8, marginRight: 8, borderRadius: 20, backgroundColor: '#F3F4F6', flexDirection: 'row', alignItems: 'center' },
  ...
  kpiValue: { fontSize: 28, fontWeight: '700', color: '#1F2937' },
  ...
  cardBadge: { backgroundColor: '#E0E7FF', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, fontSize: 12, color: '#4F46E5' },
  cardMeta: { fontSize: 12, color: '#9CA3AF' },
  cardAmount: { fontSize: 18, fontWeight: '700', color: '#059669' },
  ...
  // Buttons
  addButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#6366F1', paddingVertical: 12, borderRadius: 12, marginBottom: 16, gap: 8 },
  addButtonText: { color: '#FFF', fontWeight: '600', fontSize: 14 },
  payButton: { backgroundColor: '#10B981', paddingVertical: 10, borderRadius: 8, alignItems: 'center', marginTop: 8 },
  payButtonText: { color: '#FFF', fontWeight: '600' },

  // Payment summary
  paymentSummary: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  ...
  typeBtn: { flex: 1, padding: 12, borderRadius: 12, backgroundColor: '#F3F4F6', alignItems: 'center' },
  ...
  saveBtn: { flex: 1, padding: 16, borderRadius: 12, backgroundColor: '#6366F1', alignItems: 'center' },
